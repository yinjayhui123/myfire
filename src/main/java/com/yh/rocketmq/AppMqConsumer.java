...
// */
//@Service
//public class AppMqConsumer extends Consumer {
//
//    private static final Logger logger = LoggerFactory.getLogger(AppMqConsumer.class);
//
//    @Override
//    public void init(DefaultMQPushConsumer consumer) throws MQClientException {
//        consumer.setConsumerGroup(MQEnum.APP_SEND_TWO_GROUP.name());
////        consumer.setInstanceName(MQEnum.APP_SEND_KEYS.name());
//        consumer.setInstanceName(Long.toString(System.currentTimeMillis()));
//        //订阅PushTopic下Tag为push的消息
//        consumer.subscribe(MQEnum.APP_SEND_TOPIC_TWO.name(),"*");
...
//    //并发Concurrently,并发消费消息(性能高)。还可以使用顺序监听 Orderly
      //消费的监听 这里注意顺序消费为MessageListenerOrderly 之前并发为ConsumeConcurrentlyContext
...
//                    System.out.println("123消费响应:msgId: "+messageExt.getMsgId()+", msgBody:"+messageBody);
//                }
//            }catch (Exception e){
